							...
							<div class="card card-xxl-stretch mb-5 mb-xl-8">
								...
								<div class="card-header">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bolder fs-3 mb-1">Appointment List Information</span>
										<span class="text-muted mt-1 fw-bold fs-7">All appointment list</span>
									</h3>
									<div class="card-toolbar">
										<button class="btn btn-sm btn-light-primary" id="guestAppointmentBtn"><i class="fas fa-plus"></i>Guests Appointment</button> &nbsp;
										<button class="btn btn-sm btn-light-primary" id="userAppointmentBtn"><i class="fas fa-plus"></i>Users Appointment</button>
									</div>
								</div>
								<!--end::Card header-->
