													...
													<div class="d-flex flex-column">
														...
														<div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
															<a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
																...
																<!--end::Svg Icon-->Instence Heating</a>
																<a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
								...
								<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
									...
									<div class="card-body p-9">
										...
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-dark">{{$users->first_name}}&nbsp;{{$users->last_name}} </span>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Row-->
										...
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8 d-flex align-items-center">
												<span class="fw-bolder fs-6 me-2">{{$users->phone}}</span>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Input group-->
										...
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-dark">{{$users->address}}</span>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Row-->
